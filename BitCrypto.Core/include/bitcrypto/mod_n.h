#pragma once
#include "../include/bitcrypto/base.h"
#include "../include/bitcrypto/u256.h"
namespace bitcrypto {
struct Fn{
    uint64_t v[4];
    ...
    BITCRYPTO_HD inline static Fn inv(const Fn& a){ U256 nm2{{0xBFD25E8CD036413FULL,0xBAAEDCE6AF48A03BULL,0xFFFFFFFFFFFFFFFEULL,0xFFFFFFFFFFFFFFFFULL}}; return pow(a,nm2); }
};
}